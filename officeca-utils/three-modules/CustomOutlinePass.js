...
class CustomOutlinePass extends Pass {
  constructor(resolution, scene, camera, pixelSize) {
    super();
  ...
  setSize(width, height) {
    this.surfaceBuffer.setSize(width / this.pixelSize, height / this.pixelSize);
    //this.resolution.set(width / this.pixelSize | 0, height / this.pixelSize | 0);
    ...
    this.resolution.set( width, height );
		...
		this.fsQuad.material.uniforms.screenSize.value.set( x, y, 1 / x, 1 / y );
    ...
    return new THREE.ShaderMaterial({
      uniforms: {
        ...
        multiplierParameters: {
          value: new THREE.Vector2(1.0, 20),
        },
